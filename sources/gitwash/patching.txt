...
You've discovered a bug or something else you want to change in PyTOPKAPI_ - excellent!
...
::
   ...
   git clone git://github.com/sahg/PyTOPKAPI.git
...
Then, send the generated patch files to the `PyTOPKAPI mailing list`_ - where we will thank you warmly.
...
#. If you don't already have one, clone a copy of the PyTOPKAPI_ repository::
...
#. Finally, make your commits into patches.  You want all the commits
   ...
   Send these files to the `PyTOPKAPI mailing list`_.
...
Fork the PyTOPKAPI_ repository on github_ - :ref:`forking`.  Then::
   ...
   git remote add origin git@github.com:your-user-name/PyTOPKAPI.git
