...
==========================================
Making your own copy (fork) of PyTOPKAPI
==========================================
...
specifics for the PyTOPKAPI_ project, and to suggest some default names.
...
Create your own forked copy of PyTOPKAPI_
=========================================

#. Log into your github_ account.
#. Go to the PyTOPKAPI_ github home at `PyTOPKAPI github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause and some 'Hardcore forking action', you
   should find yourself at the home page for your own forked copy of PyTOPKAPI_.
